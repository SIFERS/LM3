...
coordenadas=str(splitext(archivoLog)[0])+'-lastOpt.com'
...
print(logFile[mem][1:],logFile[proc][1:],logFile[method][1:],sep='',file=g)
print('# estructura optimizada de ', archivoLog,'\n',file=g)
print('0 1',file=g)
