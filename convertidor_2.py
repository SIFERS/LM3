...
# #resultado = tkinter.Label(ventana, font=fontExample)
...
botonConvertir = tkinter.Button(ventana, text='Imprimir', padx=40,
                                 command=imprimir, font=fontExample)
