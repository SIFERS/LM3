...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 14 11:03:42 2021
...
f=open('y18-Br-simplif-HSE-TD-6311G.xyz','r')
datos=f.readlines()
...
for k in range(len(x)):
    ax.scatter(x[k],y[k],z[k]) # plot the point (2,3,4) on the figure
    ax.text(x[k], y[k], z[k], '%s' % (atom[k]), size=20, zorder=1, color='k')
